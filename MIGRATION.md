...
不需要删除任何已跟踪文件。本升级同步更新 R10.2 配置、广告补充快照、规则锁、文档、工具和工作流，并保留规则来源与许可证。
...
3. 检查差异后提交并推送。
4. 等待 `Audit Surge R10.2 profile` 工作流全部通过。
